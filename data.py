...
from configs.stl10_config import load_config_stl10
...
class Dataset():
    ...
    def check_dataset(self):
        supported_dataset = ['food-101', 'food-101-small', 'cifar10', 'stl10']
